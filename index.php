    ...
    <body onload="start()">
        ...
        <div class="container">
            ...
            <ul id="wheel" data-angle="all">
                <li class="item">
                    <a href="#home"><img src="images/star3.png" width="100%" height="100%" onclick="smallStarSound1(); controlLight('star3');" /></a>
                </li>
                <li class="item">
                    <a href="#home"><img src="images/star2.png" width="100%" height="100%" onclick="smallStarSound2(); controlLight('star2');" /></a>
                </li>
                <li class="item">
                    <a href="#home"><img src="images/star1.png" width="100%" height="100%" onclick="smallStarSound3(); controlLight('star1');" /></a>
                </li>
                <li class="item">
